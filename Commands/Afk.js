...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  ...
  if(sebep.toLowerCase().includes(".com") || 
sebep.toLowerCase().includes("youtube.com") || 
sebep.toLowerCase().includes("discord.gg/")|| 
sebep.includes("https://") || sebep.includes("<@&>") || 
sebep.includes("@here") || sebep.includes("@everyone")) return  [message.delete({timeout:10}),
message.channel.send("Afk nedenine **link** veya **rol** giremezsin").then(msg => msg.delete({timeout: 9000}))]
